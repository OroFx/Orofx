...
const HeroSection: React.FC = () => {
  ...
  return <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden" style={{
    background: '#0D0F14'
  }}>
      {/* Background Image */}
      ...
      {/* Content */}
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">{/* Badge */}<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#2E8BFF]/30 bg-[#2E8BFF]/10 mb-8 transition-all duration-1000" style={{
        ...
        </div>{/* Headline */}<h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] mb-6 transition-all duration-1000 delay-200" style={{
        opacity: isVisible ? 1 : 0,
        ...
        </h1>{/* Subheadline */}<p className="text-lg sm:text-xl text-[#9CA3AF] max-w-2xl mx-auto mb-10 leading-relaxed transition-all duration-1000 delay-400" style={{
        opacity: isVisible ? 1 : 0,
        transform: isVisible ? 'translateY(0)' : 'translateY(30px)'
      }}>
          {t('hero.sub1')}
          ...
          {t('hero.sub2')}
        </p>{/* CTA Buttons */}<div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 transition-all duration-1000 delay-500" style={{
        opacity: isVisible ? 1 : 0,
        transform: isVisible ? 'translateY(0)' : 'translateY(30px)'
      }}>
        ...
        </div>{/* Live Counters */}<div className="grid grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto transition-all duration-1000 delay-700" style={{
        opacity: isVisible ? 1 : 0,
        transform: isVisible ? 'translateY(0)' : 'translateY(30px)'
      }}>
          {[{
